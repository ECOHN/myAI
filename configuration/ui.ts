...
export const CHAT_HEADER: string = `Ethan's Stock Pick Provider`;
export const MESSAGE_PLACEHOLDER: string = `[MESSAGE PLACEHOLDER]`;
export const FOOTER_MESSAGE: string = `Information provided may be out of date and not current, do your own research before investing`;
export const CLEAR_BUTTON_TEXT: string = `Clear Chat`;
export const PAGE_TITLE: string = `Ethan's Chatbot`;
